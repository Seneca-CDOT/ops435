...
class lab5a(unittest.TestCase):
    ...
    def test_0(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - Test for file creation: ./lab5X.py"""
    ...
    def test_a(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - Test for errors running: ./lab5X.py"""
    ...
    def test_a1(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - Test for correct shebang line: ./lab5X.py"""
    ...
    def test_a_function_read_file_string(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - function read_file_string fails without 1 argument"""
        with self.assertRaises(Exception) as context:
            import lab5a as lab5aStudent
            lab5aStudent.read_file_string()
    
    def test_b_function_read_file_list(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - function read_file_list fails without 1 argument"""
        with self.assertRaises(Exception) as context:
            import lab5a as lab5aStudent
            lab5aStudent.read_file_list()

    def test_c_file_data_txt_exists(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - Test for file creation: ./data.txt"""
    ...
    def test_d_file_data_txt_has_correct_text(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - Test for correct contents: ./data.txt"""
...
class lab5b(unittest.TestCase):
    ...
    def test_a_function_append_file_string(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - function append_file_string fails without 2 argument"""
        with self.assertRaises(Exception) as context:
            import lab5b as lab5bStudent
            lab5bStudent.append_file_string()
    
    def test_c_function_write_file_list(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - function write_file_list fails without 2 argument"""
        with self.assertRaises(Exception) as context:
            import lab5b as lab5bStudent
            lab5bStudent.write_file_list()
    
    def test_d_function_copy_file_add_line_numbers(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - function copy_file_add_line_numbers fails without 2 argument"""
        with self.assertRaises(Exception) as context:
            import lab5b as lab5bStudent
...
class lab5c(unittest.TestCase):
    ...
    def test_a_function_add(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - function add fails without 2 argument"""
        with self.assertRaises(Exception) as context:
            import lab5c as lab5cStudent
            lab5cStudent.add()
    
    def test_b_function_read_file(self):
        """[Lab 5] - [Investigation X] - [Part X] - Files - function read_file fails without 1 argument"""
        with self.assertRaises(Exception) as context:
            import lab5c as lab5cStudent
